...
So let's call the old-age threshold at time $y = i$, following @sanderson2008rethinking, $RLE^{15}_{y=i}$, and in this case we only have it for five year time periods so $RLE^{15}_{y=i_5}$. RLE stands for remainling life expectancy.

...
2. No, still trying to figure out the jumps. They aren't from the 5 year interpolations actually. They happen everytime the threshold value goes up a notch. So the issue is with the proportional populations above and below the threshold. OK, all good! I shouldn't have interpolated the proportion of the populaiton at the threshold age, ha!

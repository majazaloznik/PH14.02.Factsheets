...
5. Also figured out that instead of the linear interpolation of the population over the threshold, I could also use splines if I used the cumulative population size instead. 
